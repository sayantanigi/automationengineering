...
<footer>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 column">
                    <div class="about_widget">
                        ...
                        <div class="link_widgets">
                            <div class="row">
                                <div class="col-lg-12">
                                    <a href="javascript:void(0)"><?= $get_setting->address?></a>
                    ...
                    <div class="social">
                        ...
                        <a href="<?php echo $get_setting->tw_link; ?>" title="" target="_blank"><img src="<?= base_url('uploads/logo-white.png')?>" style=" width: 14px; height: 13px; margin-top: 2px;"></i></a>
                        ...
                        <a href="<?php echo $get_setting->truth_social_link?>" title="" target="_blank"><img src="<?= base_url('uploads/truth_social_icon.png')?>" style=" width: 17px; height: 14px; margin-top: 1px;"></a>
    ...
    <div class="bottom-line">
        <span>Copyright © <?php echo date('Y')?> Automation Engineering Services. All rights reserved.</span>
