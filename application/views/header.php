        ...
        <header class="stick-top forsticky ">
            <div class="container-fluid Small_Header">
                <div class="Contact_Number">
                    <a href="tel: <?= $get_setting->phone ?>"><i class="fa fa-phone" aria-hidden="true"></i> +98 765-432-11</a>
                </div>
                <div class="Email">
                    <a href="mailto: <?= $get_setting->email ?>"><i class="fa fa-envelope" aria-hidden="true"></i> info@automationengineeringservices.com</a>
                </div>
                <div class="social_Icon">
                <a href="<?php echo $get_setting->fb_link; ?>" title="" target="_blank"><i class="fa fa-facebook"></i></a>
                        <a href="<?php echo $get_setting->tw_link; ?>" title="" target="_blank"><img src="<?= base_url('uploads/logo-white.png')?>" style=" width: 14px; height: 14px; margin-top: 2px;"></i></a>
                        ...
                        <a href="<?php echo $get_setting->truth_social_link?>" title="" target="_blank"><img src="<?= base_url('uploads/truth_social_icon.png')?>"></a>
                </div>                
            </div>
            <div class="menu-sec">
