												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="phone" placeholder="phone number" value="<?php if(!empty($row->phone)){echo $row->phone; }?>" required maxlength="15">
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
													...
													<div class="col-md-12">
														<div class="form-group">
															<label>Truth Social</label>
															<input type="text" class="form-control" name="truth_social_link" placeholder="Truth Social Link" value="<?php if(!empty($row->truth_social_link)){echo $row->truth_social_link; }?>">
														</div>
													</div>
